@testset "TMeshes" begin
    ...
    @test_throw AssertionError Cantilever_beam_bottom2D(2,2,:bla)
    ...
    @test_throw AssertionError Cantilever_beam_middle2D(2,2,:bla)

    #@assert iseven(ny) "Cantilever_Beam_Middle2D::ny must be even"
    @test_throw AssertionError Cantilever_beam_middle2D(2,3)
    ...
    @test_throw AssertionError Simply_supported2D(2,2,:bla)

    #@assert iseven(ny) "Simply_supported2D::nx must be even"
    @test_throw AssertionError Simply_supported2D(3,2)
    ...
    @test_throw AssertionError Simply_supported2D(3,2,2)
    @test_throw AssertionError Simply_supported2D(2,3,2)
    @test_throw AssertionError Simply_supported2D(3,3,2)
       
    # @assert etype==:truss3D "Simply_Supported3D::etype must be truss3D"
    @test_throw AssertionError Simply_supported2D(2,2,2,:bla)
    @test_throw AssertionError Simply_supported2D(2,2,2,:solid3D)
